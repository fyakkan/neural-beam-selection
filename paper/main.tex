...
per-draw standard deviation and constitute the real effect.
...
\# blocked & 0 & 6 & 8 & 10 & 12 \\
\midrule
RSRP-only            & \ms{89.2}{0.0} & \ms{70.7}{0.6} & \ms{55.5}{2.7} & \ms{36.2}{2.8} & \ms{22.6}{1.7} \\
Concatenation        & \ms{84.4}{0.0} & \ms{70.4}{1.5} & \ms{60.5}{1.6} & \textbf{\ms{45.5}{1.7}} & \ms{29.4}{2.5} \\
Plain residual       & \ms{88.0}{0.0} & \ms{72.1}{1.4} & \ms{58.7}{2.1} & \ms{40.3}{2.3} & \ms{25.0}{2.1} \\
\textbf{Gated residual} & \textbf{\ms{89.4}{0.0}} & \ms{72.3}{1.6} & \ms{58.7}{2.4} & \ms{40.1}{2.1} & \ms{25.1}{1.7} \\
\bottomrule
\end{tabular}
\end{table}
